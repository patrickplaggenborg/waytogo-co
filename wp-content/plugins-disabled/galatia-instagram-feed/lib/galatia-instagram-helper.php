...
/**
 * Class GalatiaInstagramHelper
 */
class GalatiaInstagramHelper {
	/**
	 * Generates HTML for given image from Instagram feed. Defines galatia_instagram_image_atts filter
	 *
	...
	public function getImageHTML( $image ) {
		...
		$imageAtts = apply_filters( 'galatia_instagram_image_atts',
			array(
