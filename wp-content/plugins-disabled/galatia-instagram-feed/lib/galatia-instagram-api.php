...
include 'galatia-instagram-helper.php';

/**
 * Class GalatiaInstagramApi
 */
class GalatiaInstagramApi {
	...
	const INSTAGRAM_CODE = 'galatia_instagram_code';
	const INSTAGRAM_USER_ID = 'galatia_instagram_user_id';
	const INSTAGRAM_TOKEN = 'galatia_instagram_access_token';
	const INSTAGRAM_TOKEN_LONG_LIVED = 'galatia_instagram_access_token_long_lived';
	const INSTAGRAM_TOKEN_LONG_LIVED_TIME = 'galatia_instagram_access_token_long_lived_time';

	const FACEBOOK_CODE = 'galatia_facebook_code';
	const FACEBOOK_TOKEN = 'galatia_facebook_access_token';

	const CONNECTION_TYPE = 'galatia_connection_type';
	...
	public function __construct() {
		...
		$this->helper = new GalatiaInstagramHelper();
	}
	 ...
	 *
	 * @see GalatiaInstagramApi::fetchData()
	 */
	 ...
	 * @return stdClass
	 *
	 * @see GalatiaInstagramApi::instagramExchangeCodeForToken()
	 */
