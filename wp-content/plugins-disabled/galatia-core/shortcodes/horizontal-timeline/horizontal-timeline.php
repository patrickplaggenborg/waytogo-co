<?php
namespace GalatiaCore\CPT\Shortcodes\HorizontalTimeline;
...
class HorizontalTimeline implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Horizontal Timeline', 'galatia-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						array(
							...
							'heading'     => esc_html__( 'Timeline displays?', 'galatia-core' ),
							'value'       => array(
								esc_html__( 'Only Years', 'galatia-core' )             => 'Y',
								esc_html__( 'Years and Months', 'galatia-core' )       => 'M Y',
								esc_html__( 'Years, Months and Days', 'galatia-core' ) => 'M d, \'y',
								esc_html__( 'Months and Days', 'galatia-core' )        => 'M d'
							),
							'admin_label' => true
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'distance',
							'heading'     => esc_html__( 'Minimal Distance Between Dates?', 'galatia-core' ),
							'description' => esc_html__( 'Default value is 60', 'galatia-core' ),
							'admin_label' => true
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = galatia_core_get_shortcode_module_template_part( 'templates/horizontal-timeline-holder', 'horizontal-timeline', '', $params );
