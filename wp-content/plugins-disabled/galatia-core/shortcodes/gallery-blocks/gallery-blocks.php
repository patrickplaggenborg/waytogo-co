<?php
namespace GalatiaCore\CPT\Shortcodes\GalleryBlocks;
...
class GalleryBlocks implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Gallery Blocks', 'galatia-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'description' => esc_html__( 'Select images from media library. The first image you upload will be set as the featured image if you set Featured Image Size.', 'galatia-core' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'featured_image_size',
							'heading'     => esc_html__( 'Featured Image Size', 'galatia-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Enable Lightbox Functionality', 'galatia-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		$html = galatia_core_get_shortcode_module_template_part( 'templates/gallery-blocks', 'gallery-blocks', '', $params );
