...
namespace GalatiaCore\CPT\Shortcodes\CustomFont;
...
class CustomFont implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Custom Font', 'galatia-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'       => 'textfield',
							'param_name' => 'title',
							'heading'    => esc_html__( 'Title Text', 'galatia-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type_out_effect',
							'heading'     => esc_html__( 'Enable Type Out Effect', 'galatia-core' ),
							'description' => esc_html__( 'Adds a type out effect inside custom font content', 'galatia-core' ),
							'value'       => array_flip( galatia_edge_get_yes_no_select_array( false ) )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'type_out_position',
							'heading'     => esc_html__( 'Position of Type Out Effect', 'galatia-core' ),
							'description' => esc_html__( 'Enter the position of the word after which you would like to display type out effect (e.g. if you would like the type out effect after the 3rd word, you would enter "3")', 'galatia-core' ),
							'dependency'  => array( 'element' => 'type_out_effect', 'value' => array( 'yes' ) )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'typed_color',
							'heading'    => esc_html__( 'Typed Color', 'galatia-core' ),
							'dependency' => array( 'element' => 'type_out_effect', 'value' => array( 'yes' ) )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'typed_ending_1',
							'heading'    => esc_html__( 'Typed Ending Number 1', 'galatia-core' ),
							'dependency' => Array( 'element' => 'type_out_effect', 'value' => array( 'yes' ) )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'typed_ending_2',
							'heading'    => esc_html__( 'Typed Ending Number 2', 'galatia-core' ),
							'dependency' => array( 'element' => 'typed_ending_1', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'typed_ending_3',
							'heading'    => esc_html__( 'Typed Ending Number 3', 'galatia-core' ),
							'dependency' => array( 'element' => 'typed_ending_2', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'typed_ending_4',
							'heading'    => esc_html__( 'Typed Ending Number 4', 'galatia-core' ),
						...
						array(
							...
							'description' => esc_html__( 'Enter the positions of the words after which you would like to create a line break (e.g. if you would like the line break after the 3rd and 8th words, you would enter "3,8")', 'galatia-core' ),
							'dependency'  => array( 'element' => 'title', 'not_empty' => true )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'disable_break_words',
							'heading'     => esc_html__( 'Disable Line Break for Smaller Screens', 'galatia-core' ),
							'value'       => array_flip( galatia_edge_get_yes_no_select_array( false ) ),
							'save_always' => true,
						...
						array(
							...
							'heading'    => esc_html__( 'Font Family', 'galatia-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'font_size',
							'heading'    => esc_html__( 'Font Size (px or em)', 'galatia-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'line_height',
							'heading'    => esc_html__( 'Line Height (px or em)', 'galatia-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'font_weight',
							'heading'     => esc_html__( 'Font Weight', 'galatia-core' ),
							'value'       => array_flip( galatia_edge_get_font_weight_array( true ) ),
							'save_always' => true
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'font_style',
							'heading'     => esc_html__( 'Font Style', 'galatia-core' ),
							'value'       => array_flip( galatia_edge_get_font_style_array( true ) ),
							'save_always' => true
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'letter_spacing',
							'heading'    => esc_html__( 'Letter Spacing (px or em)', 'galatia-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'text_transform',
							'heading'     => esc_html__( 'Text Transform', 'galatia-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Text Decoration', 'galatia-core' ),
							'value'       => array_flip( galatia_edge_get_text_decorations( true ) ),
							'save_always' => true
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'color',
							'heading'    => esc_html__( 'Color', 'galatia-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'text_align',
							'heading'     => esc_html__( 'Text Align', 'galatia-core' ),
							'value'       => array(
								...
								esc_html__( 'Justify', 'galatia-core' ) => 'justify'
							),
							'save_always' => true
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'margin',
							'heading'     => esc_html__( 'Margin (px or %)', 'galatia-core' ),
							'description' => esc_html__( 'Insert margin in format: top right bottom left (e.g. 10px 5px 10px 5px)', 'galatia-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'font_size_1366',
							'heading'    => esc_html__( 'Font Size (px or em)', 'galatia-core' ),
							'group'      => esc_html__( 'Laptops', 'galatia-core' )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Font Size (px or em)', 'galatia-core' ),
							'group'      => esc_html__( 'Tablets Landscape', 'galatia-core' )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Font Size (px or em)', 'galatia-core' ),
							'group'      => esc_html__( 'Tablets Portrait', 'galatia-core' )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Font Size (px or em)', 'galatia-core' ),
							'group'      => esc_html__( 'Mobiles', 'galatia-core' )
						),
						array(
							'type'       => 'textfield',
	...
	public function render( $atts, $content = null ) {
		...
		$html = galatia_core_get_shortcode_module_template_part( 'templates/custom-font', 'custom-font', '', $params );
	...
	private function getHolderStyles( $params ) {
		...
		if ( ! empty( $params['font_size'] ) ) {
			if ( galatia_edge_string_ends_with( $params['font_size'], 'px' ) || galatia_edge_string_ends_with( $params['font_size'], 'em' ) ) {
		...
		if ( ! empty( $params['line_height'] ) ) {
			if ( galatia_edge_string_ends_with( $params['line_height'], 'px' ) || galatia_edge_string_ends_with( $params['line_height'], 'em' ) ) {
		...
		if ( ! empty( $params['letter_spacing'] ) ) {
			if ( galatia_edge_string_ends_with( $params['letter_spacing'], 'px' ) || galatia_edge_string_ends_with( $params['letter_spacing'], 'em' ) ) {
	...
	private function getHolderData( $params ) {
		...
		if ( $params['font_size_1366'] !== '' ) {
			if ( galatia_edge_string_ends_with( $params['font_size_1366'], 'px' ) || galatia_edge_string_ends_with( $params['font_size_1366'], 'em' ) ) {
		...
		if ( $params['font_size_1024'] !== '' ) {
			if ( galatia_edge_string_ends_with( $params['font_size_1024'], 'px' ) || galatia_edge_string_ends_with( $params['font_size_1024'], 'em' ) ) {
		...
		if ( $params['font_size_768'] !== '' ) {
			if ( galatia_edge_string_ends_with( $params['font_size_768'], 'px' ) || galatia_edge_string_ends_with( $params['font_size_768'], 'em' ) ) {
		...
		if ( $params['font_size_680'] !== '' ) {
			if ( galatia_edge_string_ends_with( $params['font_size_680'], 'px' ) || galatia_edge_string_ends_with( $params['font_size_680'], 'em' ) ) {
		...
		if ( $params['line_height_1366'] !== '' ) {
			if ( galatia_edge_string_ends_with( $params['line_height_1366'], 'px' ) || galatia_edge_string_ends_with( $params['line_height_1366'], 'em' ) ) {
		...
		if ( $params['line_height_1024'] !== '' ) {
			if ( galatia_edge_string_ends_with( $params['line_height_1024'], 'px' ) || galatia_edge_string_ends_with( $params['line_height_1024'], 'em' ) ) {
		...
		if ( $params['line_height_768'] !== '' ) {
			if ( galatia_edge_string_ends_with( $params['line_height_768'], 'px' ) || galatia_edge_string_ends_with( $params['line_height_768'], 'em' ) ) {
		...
		if ( $params['line_height_680'] !== '' ) {
			if ( galatia_edge_string_ends_with( $params['line_height_680'], 'px' ) || galatia_edge_string_ends_with( $params['line_height_680'], 'em' ) ) {
	...
	private function getModifiedTitle( $params ) {
		...
		if ( ! empty( $title ) && ( $type_out_effect === 'yes' || ! empty( $title_break_words ) ) ) {
			...
			if ( $type_out_effect === 'yes' && ! empty( $type_out_position ) ) {
				...
				$typed_html = '<span class="edgtf-cf-typed-wrap" ' . galatia_edge_get_inline_style( $typed_styles ) . '><span class="edgtf-cf-typed">';
