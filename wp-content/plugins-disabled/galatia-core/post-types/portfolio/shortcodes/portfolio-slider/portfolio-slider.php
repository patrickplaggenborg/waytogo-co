...
class PortfolioSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Portfolio Slider', 'galatia-core' ),
					'base'     => $this->base,
					...
					'params'   => array(
						array(
							...
							'heading'     => esc_html__( 'Number of Portfolios Items', 'galatia-core' ),
							'admin_label' => true,
							'description' => esc_html__( 'Set number of items for your portfolio slider. Enter -1 to show all', 'galatia-core' )
						),
						array(
							'type'       => 'dropdown',
						...
						array(
							...
							'description' => esc_html__( 'Number of portfolios that are showing at the same time in slider (on smaller screens is responsive so there will be less items shown). Default value is Four', 'galatia-core' ),
							'save_always' => true
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'description' => esc_html__( 'Set image proportions for your portfolio slider.', 'galatia-core' ),
							'save_always' => true
						),
						array(
							'type'        => 'autocomplete',
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Loop', 'galatia-core' ),
							'value'       => array_flip( galatia_edge_get_yes_no_select_array( false, false ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'galatia-core' ),
							'dependency'  => array( 'element' => 'item_type', 'value' => array( '' ) )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'enable_autoplay',
							'heading'     => esc_html__( 'Enable Slider Autoplay', 'galatia-core' ),
							'value'       => array_flip( galatia_edge_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'galatia-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Slide Duration', 'galatia-core' ),
							'description' => esc_html__( 'Default value is 5000 (ms)', 'galatia-core' ),
							'group'       => esc_html__( 'Slider Settings', 'galatia-core' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'slider_speed_animation',
							'heading'     => esc_html__( 'Slide Animation Duration', 'galatia-core' ),
							'description' => esc_html__( 'Speed of slide animation in milliseconds. Default value is 600.', 'galatia-core' ),
							'group'       => esc_html__( 'Slider Settings', 'galatia-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'enable_navigation',
							'heading'     => esc_html__( 'Enable Slider Navigation Arrows', 'galatia-core' ),
							'value'       => array_flip( galatia_edge_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'galatia-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Navigation Skin', 'galatia-core' ),
							'value'      => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Pagination', 'galatia-core' ),
							'value'       => array_flip( galatia_edge_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'galatia-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Pagination Skin', 'galatia-core' ),
							'value'      => array(
								esc_html__( 'Default', 'galatia-core' ) => '',
								esc_html__( 'Light', 'galatia-core' )   => 'light',
								esc_html__( 'Dark', 'galatia-core' )    => 'dark'
						...
						array(
							...
							'heading'     => esc_html__( 'Pagination Position', 'galatia-core' ),
							'value'       => array(
								esc_html__( 'Below Slider', 'galatia-core' ) => 'below-slider',
								esc_html__( 'On Slider', 'galatia-core' )    => 'on-slider'
							),
							'save_always' => true,
							'dependency'  => array( 'element' => 'enable_pagination', 'value' => array( 'yes' ) ),
							'group'       => esc_html__( 'Slider Settings', 'galatia-core' )
