<?php
namespace GalatiaCore\CPT\Shortcodes\ImageGallery;
...
class ImageGallery implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Image Gallery', 'galatia-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type',
							'heading'     => esc_html__( 'Gallery Type', 'galatia-core' ),
							'value'       => array(
								esc_html__( 'Image Grid', 'galatia-core' ) => 'grid',
								esc_html__( 'Masonry', 'galatia-core' )    => 'masonry',
								esc_html__( 'Slider', 'galatia-core' )     => 'slider',
								esc_html__( 'Carousel', 'galatia-core' )   => 'carousel'
							),
							'save_always' => true,
							'admin_label' => true
						),
						...
						array(
							...
							'heading'     => esc_html__( 'Image Size', 'galatia-core' ),
							'description' => esc_html__( 'Enter image size. Example: thumbnail, medium, large, full or other sizes defined by current theme. Alternatively enter image size in pixels: 200x100 (Width x Height). Leave empty to use "full" size', 'galatia-core' )
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'heading'    => esc_html__( 'Image Behavior', 'galatia-core' ),
							'value'      => array(
								esc_html__( 'None', 'galatia-core' )             => '',
								esc_html__( 'Open Lightbox', 'galatia-core' )    => 'lightbox',
								esc_html__( 'Open Custom Link', 'galatia-core' ) => 'custom-link',
								esc_html__( 'Zoom', 'galatia-core' )             => 'zoom',
								esc_html__( 'Grayscale', 'galatia-core' )        => 'grayscale'
							)
						),
						array(
							'type'        => 'textarea',
						...
						array(
							...
							'heading'     => esc_html__( 'Number Of Visible Items', 'galatia-core' ),
							'value'       => array(
								esc_html__( 'One', 'galatia-core' )   => '1',
								esc_html__( 'Two', 'galatia-core' )   => '2',
								esc_html__( 'Three', 'galatia-core' ) => '3',
								esc_html__( 'Four', 'galatia-core' )  => '4',
								esc_html__( 'Five', 'galatia-core' )  => '5',
								esc_html__( 'Six', 'galatia-core' )   => '6'
							),
							'save_always' => true,
                        ...
                        array(
                            ...
                            'heading'     => esc_html__( 'Slider Auto Width', 'galatia-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Padding', 'galatia-core' ),
							'description' => esc_html__( 'Padding left and right on stage (can see neighbours).', 'galatia-core' ),
							'value'       => array_flip( galatia_edge_get_yes_no_select_array( false ) ),
							'save_always' => true,
	...
	public function render( $atts, $content = null ) {
		...
		$html = galatia_core_get_shortcode_module_template_part( 'templates/' . $params['type'], 'image-gallery', '', $params );
	...
	private function getHolderClasses( $params, $args ) {
        ...
        $holderClasses[] = $params['slider_auto_width'] === 'yes' ? 'edgtf-slider-auto-width' : '';
