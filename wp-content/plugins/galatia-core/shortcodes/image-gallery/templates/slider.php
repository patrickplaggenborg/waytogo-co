...
<div class="edgtf-image-gallery <?php echo esc_attr($holder_classes); ?>">
    <div class="edgtf-image-gallery-next-slide-overlay"></div>
	<div class="edgtf-ig-slider edgtf-owl-slider" <?php echo galatia_edge_get_inline_attrs($slider_data); ?>>
			...
			<div class="edgtf-ig-image">
				...
				<?php } ?>
					<?php if(is_array($image_size) && count($image_size)) :
						echo galatia_edge_generate_thumbnail($image['image_id'], null, $image_size[0], $image_size[1]);
					else:
