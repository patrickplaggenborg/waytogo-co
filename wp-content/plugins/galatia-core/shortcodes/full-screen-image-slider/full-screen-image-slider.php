<?php
namespace GalatiaCore\CPT\Shortcodes\FullScreenImageSlider;
...
class FullScreenImageSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Full Screen Image Slider', 'galatia-core' ),
					'base'                      => $this->getBase(),
	...
	public function render( $atts, $content = null ) {
		...
		$html = galatia_core_get_shortcode_module_template_part( 'templates/full-screen-image-slider', 'full-screen-image-slider', '', $params );
