<?php
namespace GalatiaCore\CPT\Shortcodes\InteractiveLinkShowcase;
...
class InteractiveLinkShowcase implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Interactive Link Showcase', 'galatia-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							'type'        => 'dropdown',
							'param_name'  => 'skin',
							'heading'     => esc_html__( 'Link Skin', 'galatia-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Link Items', 'galatia-core' ),
							'params'     => array(
								array(
									'type'       => 'textfield',
									'param_name' => 'title',
	...
	public function render( $atts, $content = null ) {
		...
		$html = galatia_core_get_shortcode_module_template_part( 'templates/interactive-link-showcase', 'interactive-link-showcase', '', $params );
