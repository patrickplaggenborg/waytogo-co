<?php
if ( ! function_exists( 'galatia_edge_init_google_fonts_array' ) ) {
    function galatia_edge_init_google_fonts_array() {
        ...
        $galatia_edge_global_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'galatia_edge_init_google_fonts_array');
}