...
if ( ! function_exists( 'galatia_edge_add_dripicons_icon_pack' ) ) {
	function galatia_edge_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new GalatiaEdgeClassDripicons( 'Dripicons', 'dripicon' );

		return $iconCollections;
	}

	add_filter( 'galatia_edge_filter_add_icon_pack_into_collection', 'galatia_edge_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'galatia_edge_add_dripicons_icon_pack_option' ) ) {
	function galatia_edge_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'galatia' );

		return $options;
	}

	add_filter( 'galatia_edge_filter_add_icon_pack_into_options', 'galatia_edge_add_dripicons_icon_pack_option' );
}

class GalatiaEdgeClassDripicons implements iGalatiaEdgeInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
