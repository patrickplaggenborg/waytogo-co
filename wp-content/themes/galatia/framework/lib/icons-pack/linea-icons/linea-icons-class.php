...
if ( ! function_exists( 'galatia_edge_add_linea_icon_pack' ) ) {
	function galatia_edge_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new GalatiaEdgeClassLineaIcons( 'Linea Icons', 'linea_icon' );

		return $iconCollections;
	}

	add_filter( 'galatia_edge_filter_add_icon_pack_into_collection', 'galatia_edge_add_linea_icon_pack' );
}

if ( ! function_exists( 'galatia_edge_add_linea_icon_pack_option' ) ) {
	function galatia_edge_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'galatia' );

		return $options;
	}

	add_filter( 'galatia_edge_filter_add_icon_pack_into_options', 'galatia_edge_add_linea_icon_pack_option' );
}

class GalatiaEdgeClassLineaIcons implements iGalatiaEdgeInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
