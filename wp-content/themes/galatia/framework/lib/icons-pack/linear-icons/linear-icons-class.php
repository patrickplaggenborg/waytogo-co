...
if ( ! function_exists( 'galatia_edge_add_linear_icon_pack' ) ) {
	function galatia_edge_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new GalatiaEdgeClassLinearIcons( 'Linear Icons', 'linear_icon' );

		return $iconCollections;
	}

	add_filter( 'galatia_edge_filter_add_icon_pack_into_collection', 'galatia_edge_add_linear_icon_pack' );
}

if ( ! function_exists( 'galatia_edge_add_linear_icon_pack_option' ) ) {
	function galatia_edge_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'galatia' );

		return $options;
	}

	add_filter( 'galatia_edge_filter_add_icon_pack_into_options', 'galatia_edge_add_linear_icon_pack_option' );
}

class GalatiaEdgeClassLinearIcons implements iGalatiaEdgeInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
