...
if ( ! function_exists( 'galatia_edge_add_simple_line_icon_pack' ) ) {
	function galatia_edge_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new GalatiaEdgeClassSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );

		return $iconCollections;
	}

	add_filter( 'galatia_edge_filter_add_icon_pack_into_collection', 'galatia_edge_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'galatia_edge_add_simple_line_icon_pack_option' ) ) {
	function galatia_edge_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'galatia' );

		return $options;
	}

	add_filter( 'galatia_edge_filter_add_icon_pack_into_options', 'galatia_edge_add_simple_line_icon_pack_option' );
	add_filter( 'galatia_edge_filter_add_icon_pack_into_social_options', 'galatia_edge_add_simple_line_icon_pack_option' );
}

class GalatiaEdgeClassSimpleLineIcons implements iGalatiaEdgeInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	public function setSocialIconsArray() {
		$this->socialIcons = array(
			''                        => '',
			'icon-social-behance'     => esc_html__( 'Behance', 'galatia' ),
			'icon-social-dribbble'    => esc_html__( 'Dribbble', 'galatia' ),
			'icon-social-dropbox'     => esc_html__( 'Dropbox', 'galatia' ),
			'icon-social-facebook'    => esc_html__( 'Facebook', 'galatia' ),
			'icon-social-foursquare'  => esc_html__( 'Foursquare', 'galatia' ),
			'icon-social-github'      => esc_html__( 'Github', 'galatia' ),
			'icon-social-gplus'       => esc_html__( 'Google Plus', 'galatia' ),
			'icon-social-instagram'   => esc_html__( 'Instagram', 'galatia' ),
			'icon-social-linkedin'    => esc_html__( 'LinkedIn', 'galatia' ),
			'icon-social-pintarest'   => esc_html__( 'Pinterest', 'galatia' ),
			'icon-social-reddit'      => esc_html__( 'Reddit', 'galatia' ),
			'icon-social-skype'       => esc_html__( 'Skype', 'galatia' ),
			'icon-social-soundcloud'  => esc_html__( 'Soundcloud', 'galatia' ),
			'icon-social-stumbleupon' => esc_html__( 'Stumbleupon', 'galatia' ),
			'icon-social-spotify'     => esc_html__( 'Spotify', 'galatia' ),
			'icon-social-tumblr'      => esc_html__( 'Tumblr', 'galatia' ),
			'icon-social-twitter'     => esc_html__( 'Twitter', 'galatia' ),
			'icon-social-youtube'     => esc_html__( 'Youtube', 'galatia' )
		);
	}
