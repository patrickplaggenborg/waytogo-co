...
if ( ! function_exists( 'galatia_edge_add_font_awesome_icon_pack' ) ) {
	function galatia_edge_add_font_awesome_icon_pack( $iconCollections ) {
		$iconCollections['font_awesome'] = new GalatiaEdgeClassIconsFontAwesome( 'Font Awesome', 'fa_icon' );

		return $iconCollections;
	}

	add_filter( 'galatia_edge_filter_add_icon_pack_into_collection', 'galatia_edge_add_font_awesome_icon_pack' );
}

if ( ! function_exists( 'galatia_edge_add_font_awesome_icon_pack_option' ) ) {
	function galatia_edge_add_font_awesome_icon_pack_option( $options ) {
		$options['font_awesome'] = esc_html__( 'Font Awesome', 'galatia' );

		return $options;
	}

	add_filter( 'galatia_edge_filter_add_icon_pack_into_options', 'galatia_edge_add_font_awesome_icon_pack_option' );
	add_filter( 'galatia_edge_filter_add_icon_pack_into_social_options', 'galatia_edge_add_font_awesome_icon_pack_option' );
}

class GalatiaEdgeClassIconsFontAwesome implements iGalatiaEdgeInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
