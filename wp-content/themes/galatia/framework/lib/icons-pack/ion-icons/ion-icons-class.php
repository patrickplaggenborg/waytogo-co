...
if ( ! function_exists( 'galatia_edge_add_ion_icon_pack' ) ) {
	function galatia_edge_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new GalatiaEdgeClassIonIcons( 'Ion Icons', 'ion_icon' );

		return $iconCollections;
	}

	add_filter( 'galatia_edge_filter_add_icon_pack_into_collection', 'galatia_edge_add_ion_icon_pack' );
}

if ( ! function_exists( 'galatia_edge_add_ion_icon_pack_option' ) ) {
	function galatia_edge_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'galatia' );

		return $options;
	}

	add_filter( 'galatia_edge_filter_add_icon_pack_into_options', 'galatia_edge_add_ion_icon_pack_option' );
	add_filter( 'galatia_edge_filter_add_icon_pack_into_social_options', 'galatia_edge_add_ion_icon_pack_option' );
}

class GalatiaEdgeClassIonIcons implements iGalatiaEdgeInterfaceIconCollection {
	public $icons;
	public $socialIcons;
	public $title;
	public $param;
