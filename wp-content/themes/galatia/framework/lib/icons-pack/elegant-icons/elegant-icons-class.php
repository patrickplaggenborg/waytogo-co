...
if ( ! function_exists( 'galatia_edge_add_font_elegant_icon_pack' ) ) {
	function galatia_edge_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new GalatiaEdgeClassIconsFontElegant( 'Font Elegant', 'fe_icon' );

		return $iconCollections;
	}

	add_filter( 'galatia_edge_filter_add_icon_pack_into_collection', 'galatia_edge_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'galatia_edge_add_font_elegant_icon_pack_option' ) ) {
	function galatia_edge_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'galatia' );

		return $options;
	}

	add_filter( 'galatia_edge_filter_add_icon_pack_into_options', 'galatia_edge_add_font_elegant_icon_pack_option' );
	add_filter( 'galatia_edge_filter_add_icon_pack_into_social_options', 'galatia_edge_add_font_elegant_icon_pack_option' );
}

class GalatiaEdgeClassIconsFontElegant implements iGalatiaEdgeInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
