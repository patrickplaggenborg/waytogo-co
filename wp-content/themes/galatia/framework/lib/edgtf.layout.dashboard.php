...
/*
   Class: GalatiaEdgeClassDashboardForm
   A class that initializes Edge Dashboard Container
*/

class GalatiaEdgeClassDashboardForm implements iGalatiaEdgeInterfaceLayoutNode, iGalatiaEdgeInterfaceRender {
	public $children;
	public $name;
	public $form_id;
	public $form_method;
...
/*
   Class: GalatiaEdgeClassDashboardGroup
   A class that initializes GalatiaEdgeClass Group Field
*/

class GalatiaEdgeClassDashboardGroup implements iGalatiaEdgeInterfaceLayoutNode, iGalatiaEdgeInterfaceRender {
	public $children;
	public $name;
	public $title;
	public $description;
...
/*
   Class: GalatiaEdgeClassDashboardTitle
   A class that initializes Dashboard Title
*/

class GalatiaEdgeClassDashboardTitle implements iGalatiaEdgeInterfaceRender {
	private $name;
	private $title;
	private $args = array();
...
/*
   Class: GalatiaEdgeClassDashboardField
   A class that initializes GalatiaEdgeClass Front Field
*/

class GalatiaEdgeClassDashboardField implements iGalatiaEdgeInterfaceRender {
	private $type;
	private $name;
	private $label;
	private $description;
...
abstract class GalatiaEdgeClassDashboardFieldType {
	abstract public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = "" );
}

class GalatiaEdgeClassDashboardFieldText extends GalatiaEdgeClassDashboardFieldType {
...
class GalatiaEdgeClassDashboardFieldTextArea extends GalatiaEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
...
class GalatiaEdgeClassDashboardFieldImage extends GalatiaEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$class = '';
            ...
            <div class="edgtf-dashboard-gallery-holder">
                <ul class="edgtf-dashboard-gallery-images-holder">
					<?php if ( isset( $value_html ) ) {
						echo galatia_edge_get_module_part( $value_html );
					} ?>
                </ul>
                <div class="edgtf-dashboard-gallery-uploader">
					<?php
					if ( galatia_membership_theme_installed() ) {
						echo galatia_edge_get_button_html( array(
							'text'         => esc_html__( 'Upload', 'galatia' ),
							'custom_class' => 'edgtf-dashboard-gallery-upload'
						) );
					} else {
						echo '<a itemprop="url" href="#" class="edgtf-btn edgtf-btn-medium edgtf-btn-solid edgtf-dashboard-gallery-upload"><span class="edgtf-btn-text">' . esc_html__( 'Upload', 'galatia' ) . '</span></a>';
					} ?>
					...
					<?php if ( $value !== '' && $value !== false ) { ?>
                        <button class="edgtf-btn edgtf-btn-solid edgtf-dashboard-remove-image"><?php esc_html_e( 'Remove Media', 'galatia' ); ?></button>
					<?php } ?>
                </div>
            </div>
        </div>
...
class GalatiaEdgeClassDashboardFieldGallery extends GalatiaEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$class = '';
...
class GalatiaEdgeClassDashboardFieldSelect extends GalatiaEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$class = '';
...
class GalatiaEdgeClassDashboardFieldDate extends GalatiaEdgeClassFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		if ( ! empty( $repeat ) && array_key_exists( 'name', $repeat ) && array_key_exists( 'index', $repeat ) ) {
			$id   = $name . '-' . $repeat['index'];
			$name = $repeat['name'] . '[' . $repeat['index'] . '][' . $name . ']';
...
class GalatiaEdgeClassDashboardFieldIcon extends GalatiaEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$options           = galatia_edge_icon_collections()->getIconCollectionsEmpty();
                            ...
                            <div class="edgtf-icon-collection-holder <?php echo esc_attr( $field_class ); ?>" data-icon-collection="<?php echo esc_attr( $icons_collection ); ?>">
                                <select name="<?php echo esc_attr( $name . '[' . $icons_param . ']' ); ?>" id="<?php echo esc_attr( $name . '[' . $icons_param . ']' ); ?>">
									...
									foreach ( $icons->icons as $key => $ivalue ) { ?>
                                        <option <?php if ( $active_icon == $ivalue ) {
											echo "selected='selected'";
										} ?> value="<?php echo esc_attr( $ivalue ); ?>"><?php echo esc_attr( $key ); ?></option>
									<?php } ?>
                                </select>
                            </div>
						<?php } ?>
...
class GalatiaEdgeClassDashboardFieldColor extends GalatiaEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		if ( ! empty( $repeat ) && array_key_exists( 'name', $repeat ) && array_key_exists( 'index', $repeat ) ) {
			$id   = $name . '-' . $repeat['index'];
			$name = $repeat['name'] . '[' . $repeat['index'] . '][' . $name . ']';
...
class GalatiaEdgeClassDashboardFieldCheckBoxGroup extends GalatiaEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
...
class GalatiaEdgeClassDashboardFieldAddress extends GalatiaEdgeClassFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
		if ( isset( $args["col_width"] ) ) {
			$col_width = $args["col_width"];
...
class GalatiaEdgeClassDashboardRepeater implements iGalatiaEdgeInterfaceRender {
	private $label;
	private $description;
	private $name;
	private $fields;
			...
			<?php if ( $this->table_layout ) { ?>
                <div class="edgtf-dashboard-repeater-table-heading">
                    <div class="edgtf-dashboard-repeater-fields-holder">
                        <div class="edgtf-dashboard-repeater-table-cell edgtf-dashboard-repeater-sort"><?php esc_html_e( 'Order', 'galatia' ) ?></div>
                        ...
                        <div class="edgtf-dashboard-repeater-table-cell edgtf-dashboard-repeater-remove"><?php esc_html_e( 'Remove', 'galatia' ) ?></div>
                    </div>
                </div>
			<?php } ?>
...
class GalatiaEdgeClassDashboardFieldFactory {
	public function render( $field_type, $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		switch ( strtolower( $field_type ) ) {
			case 'text':
				$field = new GalatiaEdgeClassDashboardFieldText();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'textarea':
				$field = new GalatiaEdgeClassDashboardFieldTextArea();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'date':
				$field = new GalatiaEdgeClassDashboardFieldDate();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'image':
				$field = new GalatiaEdgeClassDashboardFieldImage();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'gallery':
				$field = new GalatiaEdgeClassDashboardFieldGallery();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'select':
				$field = new GalatiaEdgeClassDashboardFieldSelect();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'icon':
				$field = new GalatiaEdgeClassDashboardFieldIcon();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'color':
				$field = new GalatiaEdgeClassDashboardFieldColor();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'checkboxgroup':
				$field = new GalatiaEdgeClassDashboardFieldCheckBoxGroup();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'address':
				$field = new GalatiaEdgeClassDashboardFieldAddress();
