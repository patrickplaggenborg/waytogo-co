...
<div class="edgtf-pli edgtf-item-space <?php echo esc_attr( $item_classes ); ?>">
	<div class="edgtf-pli-inner">
		...
		<div class="edgtf-pli-text" <?php echo galatia_edge_get_inline_style( $shader_styles ); ?>>
	...
	<div class="edgtf-pli-text-wrapper" <?php echo galatia_edge_get_inline_style( $text_wrapper_styles ); ?>>
