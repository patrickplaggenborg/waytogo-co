...
if ( class_exists( 'GalatiaEdgeClassWidget' ) ) {
    class GalatiaEdgeClassClassIconsGroupWidget extends GalatiaEdgeClassWidget
    {
        public function __construct()
        {
            parent::__construct(
                'edgtf_social_icons_group_widget',
                esc_html__('Galatia Social Icons Group Widget', 'galatia'),
                array('description' => esc_html__('Use this widget to add a group of up to 6 social icons to a widget area.', 'galatia'))
            );
        ...
        protected function setParams()
        {
            $this->params = array_merge(
                ...
                galatia_edge_icon_collections()->getSocialIconWidgetMultipleParamsArray(6),
                array(
                    array(
                        'type' => 'dropdown',
                        'name' => 'layout',
                        'title' => esc_html__('Icons Layout', 'galatia'),
                        'options' => array(
                            '' => esc_html__('Default', 'galatia'),
                            'square-icons' => esc_html__('Square', 'galatia'),
                        )
                    ),
                    array(
                        'type' => 'dropdown',
                        'name' => 'skin',
                        'title' => esc_html__('Square Icons Skin', 'galatia'),
                        'description' => esc_html__('This applies to the square layout', 'galatia'),
                        'options' => array(
                            '' => esc_html__('Dark Skin', 'galatia'),
                            'light-skin' => esc_html__('Light Skin', 'galatia'),
                        )
                    ),
                    array(
                        'type' => 'dropdown',
                        'name' => 'alignment',
                        'title' => esc_html__('Text Alignment', 'galatia'),
                        'options' => array(
                    ...
                    array(
                        'type' => 'textfield',
                        'name' => 'icon_size',
                        'title' => esc_html__('Icons Size (px)', 'galatia')
                    ),
                    array(
                        'type' => 'colorpicker',
                        'name' => 'color',
