...
if ( class_exists( 'GalatiaEdgeClassWidget' ) ) {
    class GalatiaEdgeClassContactForm7Widget extends GalatiaEdgeClassWidget
    {
        public function __construct()
        {
            parent::__construct(
                'edgtf_contact_form_7_widget',
                esc_html__('Galatia Contact Form 7 Widget', 'galatia'),
                array('description' => esc_html__('Add contact form 7 to widget areas', 'galatia'))
            );
        ...
        protected function setParams()
        {
            ...
            $this->params = array(
                array(
                    'type' => 'textfield',
                    'name' => 'extra_class',
                    'title' => esc_html__('Extra Class Name', 'galatia')
                ),
                array(
                    'type' => 'textfield',
                ...
                array(
                    'type' => 'dropdown',
                    'name' => 'contact_form',
                    'title' => esc_html__('Select Contact Form 7', 'galatia'),
                    'options' => $contact_forms
                ),
                array(
                    'type' => 'dropdown',
                    'name' => 'contact_form_style',
                    'title' => esc_html__('Contact Form 7 Style', 'galatia'),
                    'options' => array(
        ...
        public function widget($args, $instance)
        {
            ...
            ?>
            <div class="widget edgtf-contact-form-7-widget <?php echo esc_attr($extra_class); ?>" <?php echo galatia_edge_get_inline_style($widget_styles); ?>>
