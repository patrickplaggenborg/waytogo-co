...
if ( class_exists( 'GalatiaEdgeClassWidget' ) ) {
    class GalatiaEdgeClassRecentPosts extends GalatiaEdgeClassWidget
    {
        public function __construct()
        {
            parent::__construct(
                'edgtf_recent_posts',
                esc_html__('Galatia Recent Posts', 'galatia'),
                array('description' => esc_html__('Select recent posts that you would like to display', 'galatia'))
            );
        ...
        public function widget($args, $instance)
        {
            ...
            $html = '<div class="widget edgtf-recent-post-widget" ' . galatia_edge_get_inline_style($widget_styles) . '>';
            ...
            if ($query->have_posts()) {
                ...
                $html .= esc_html__('Sorry, there are no posts matching your criteria', 'galatia');
            }
            ...
            echo galatia_edge_get_module_part($html);
        }
    }
}