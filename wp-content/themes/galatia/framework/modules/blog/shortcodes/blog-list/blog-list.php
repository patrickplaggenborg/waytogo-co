<?php
namespace GalatiaCore\CPT\Shortcodes\BlogList;
...
class BlogList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Blog List', 'galatia' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					array(
						...
						'value'       => array(
                            ...
                            esc_html__( 'Boxed', 'galatia' )    => 'boxed',
					...
					array(
						...
						'heading'    => esc_html__( 'Number of Posts', 'galatia' )
					),
					array(
						'type'       => 'dropdown',
					...
					array(
						'type'        => 'autocomplete',
						'param_name'  => 'category',
						'heading'     => esc_html__( 'Category', 'galatia' ),
						'description' => esc_html__( 'Enter one category slug (leave empty for showing all categories)', 'galatia' )
					),
					array(
						'type'       => 'dropdown',
						'param_name' => 'image_size',
						'heading'    => esc_html__( 'Image Size', 'galatia' ),
						'value'      => array(
							...
							esc_html__( 'Thumbnail', 'galatia' ) => 'thumbnail',
                    ...
                    array(
                        ...
                        'heading'    => esc_html__( 'Box Background Color', 'galatia' ),
                        'group'      => esc_html__( 'Post Info', 'galatia' ),
					...
					array(
						...
						'heading'     => esc_html__( 'Text Length', 'galatia' ),
						'description' => esc_html__( 'Number of words', 'galatia' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Image', 'galatia' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Section', 'galatia' ),
						'value'      => array_flip( galatia_edge_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'type', 'value'   => array( 'standard', 'boxed', 'masonry' ) ),
						'group'      => esc_html__( 'Post Info', 'galatia' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Author', 'galatia' ),
						'value'      => array_flip( galatia_edge_get_yes_no_select_array( false, true ) ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Date', 'galatia' ),
						'value'      => array_flip( galatia_edge_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'galatia' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Category', 'galatia' ),
						'value'      => array_flip( galatia_edge_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'galatia' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Comments', 'galatia' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Like', 'galatia' ),
						'value'      => array_flip( galatia_edge_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'galatia' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Share', 'galatia' ),
						'value'      => array_flip( galatia_edge_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'galatia' )
					),
                    array(
						...
						'heading'    => esc_html__( 'Enable Post Info Read More button', 'galatia' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Pagination Type', 'galatia' ),
						'value'      => array(
							esc_html__( 'None', 'galatia' )            => 'no-pagination',
							esc_html__( 'Standard', 'galatia' )        => 'standard-shortcodes',
							esc_html__( 'Load More', 'galatia' )       => 'load-more',
							esc_html__( 'Infinite Scroll', 'galatia' ) => 'infinite-scroll'
						),
						'group'      => esc_html__( 'Additional Features', 'galatia' )
					)
				)
			)
		);
	...
	public function render( $atts, $content = null ) {
		...
		galatia_edge_get_module_template_part( 'shortcodes/blog-list/holder', 'blog', $params['type'], $params );
	...
	private function getBoxStyles($params){
	    ...
	    if(!empty($params['box_bg_color'])){
	        $styles[] = 'background-color: ' . $params['box_bg_color'];
        }
	...
	public function blogCategoryAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				...
				$data['label'] = ( ( strlen( $value['category_title'] ) > 0 ) ? esc_html__( 'Category', 'galatia' ) . ': ' . $value['category_title'] : '' );
				$results[]     = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( is_object( $category ) ) {
				...
				if ( ! empty( $category_title ) ) {
					$category_title_display = esc_html__( 'Category', 'galatia' ) . ': ' . $category_title;
				}
