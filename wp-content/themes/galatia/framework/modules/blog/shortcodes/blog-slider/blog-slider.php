<?php
namespace GalatiaCore\CPT\Shortcodes\BlogSlider;
...
class BlogSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Blog Slider', 'galatia' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					array(
						...
						'value'       => array(
							esc_html__( 'Slider', 'galatia' )            => 'slider',
							esc_html__( 'Carousel', 'galatia' )          => 'carousel',
							esc_html__( 'Carousel Centered', 'galatia' ) => 'carousel-centered'
						),
						'save_always' => true
					),
					array(
	...
	public function render( $atts, $content = null ) {
		...
		galatia_edge_get_module_template_part( 'shortcodes/blog-slider/holder', 'blog', '', $params );
