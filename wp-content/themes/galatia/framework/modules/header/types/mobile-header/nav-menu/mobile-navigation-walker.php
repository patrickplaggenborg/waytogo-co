...
if ( ! class_exists( 'GalatiaEdgeClassMobileNavigationWalker' ) ) {
	class GalatiaEdgeClassMobileNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if ( $item->hide == "" ) {
				...
				if ( $args->has_children ) {
					$item_output .= '<span class="mobile_arrow"><i class="edgtf-sub-arrow ion-ios-arrow-right"></i><i class="fa fa-angle-down"></i></span>';
				}
			}
