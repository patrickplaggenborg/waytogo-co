...
if ( ! function_exists( 'galatia_edge_get_hide_dep_for_header_vertical_menu_options' ) ) {
	function galatia_edge_get_hide_dep_for_header_vertical_menu_options() {
		$hide_dep_options = apply_filters( 'galatia_edge_filter_header_vertical_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'galatia_edge_header_vertical_navigation_options_map' ) ) {
	function galatia_edge_header_vertical_navigation_options_map() {
		$hide_dep_options = galatia_edge_get_hide_dep_for_header_vertical_menu_options();
		
		$panel_vertical_main_menu = galatia_edge_add_admin_panel(
			array(
				'title'           => esc_html__( 'Vertical Main Menu', 'galatia' ),
		...
		$drop_down_group = galatia_edge_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Set a style for dropdown menu', 'galatia' )
			)
		);
		
		$vertical_drop_down_row1 = galatia_edge_add_admin_row(
			array(
		...
		galatia_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Top Margin', 'galatia' ),
				'args'          => array(
					'suffix' => 'px'
				),
		...
		galatia_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Bottom Margin', 'galatia' ),
				'args'          => array(
					'suffix' => 'px'
				),
				'parent'        => $vertical_drop_down_row1
		...
		galatia_edge_add_admin_field(
			array(
				...
				'default_value' => 'below',
				'label'         => esc_html__( 'Submenu Opening', 'galatia' ),
				'options'		=> array(
					'below' => esc_html__('Below', 'galatia'),
					'side' => esc_html__('On Side', 'galatia'),
				),
				'parent'        => $panel_vertical_main_menu
			)
		);

		$group_vertical_first_level = galatia_edge_add_admin_group(
			array(
				'name'        => 'group_vertical_first_level',
				'title'       => esc_html__( '1st level', 'galatia' ),
				'description' => esc_html__( 'Define styles for 1st level menu', 'galatia' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_first_level_1 = galatia_edge_add_admin_row(
			array(
		...
		$row_vertical_first_level_2 = galatia_edge_add_admin_row(
			array(
		...
		$row_vertical_first_level_3 = galatia_edge_add_admin_row(
			array(
		...
		$group_vertical_second_level = galatia_edge_add_admin_group(
			array(
				'name'        => 'group_vertical_second_level',
				'title'       => esc_html__( '2nd level', 'galatia' ),
				'description' => esc_html__( 'Define styles for 2nd level menu', 'galatia' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_second_level_1 = galatia_edge_add_admin_row(
			array(
		...
		$row_vertical_second_level_2 = galatia_edge_add_admin_row(
			array(
		...
		$row_vertical_second_level_3 = galatia_edge_add_admin_row(
			array(
		...
		$group_vertical_third_level = galatia_edge_add_admin_group(
			array(
				'name'        => 'group_vertical_third_level',
				'title'       => esc_html__( '3rd level', 'galatia' ),
				'description' => esc_html__( 'Define styles for 3rd level menu', 'galatia' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_third_level_1 = galatia_edge_add_admin_row(
			array(
		...
		$row_vertical_third_level_2 = galatia_edge_add_admin_row(
			array(
		...
		$row_vertical_third_level_3 = galatia_edge_add_admin_row(
			array(
	...
	add_action( 'galatia_edge_action_additional_header_main_navigation_options_map', 'galatia_edge_header_vertical_navigation_options_map', 10, 1 );
}