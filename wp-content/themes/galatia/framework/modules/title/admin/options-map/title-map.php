...
if ( ! function_exists( 'galatia_edge_get_title_types_options' ) ) {
	function galatia_edge_get_title_types_options() {
		$title_type_options = apply_filters( 'galatia_edge_filter_title_type_global_option', $title_type_options = array() );
		
		return $title_type_options;
	}
}

if ( ! function_exists( 'galatia_edge_get_title_type_default_options' ) ) {
	function galatia_edge_get_title_type_default_options() {
		$title_type_option = apply_filters( 'galatia_edge_filter_default_title_type_global_option', $title_type_option = '' );
...
if ( ! function_exists('galatia_edge_title_options_map') ) {
	function galatia_edge_title_options_map() {
		$title_type_options        = galatia_edge_get_title_types_options();
		$title_type_default_option = galatia_edge_get_title_type_default_options();
		...
		$panel_title = galatia_edge_add_admin_panel(
			array(
				'page' => '_title_page',
				'name' => 'panel_title',
				'title' => esc_html__('Title Settings', 'galatia')
			)
		);
		...
		galatia_edge_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'This option will enable/disable Title Area', 'galatia' ),
				'parent'        => $panel_title
			)
		);
		
			$show_title_area_container = galatia_edge_add_admin_container(
				array(
					'parent'          => $panel_title,
				...
				galatia_edge_add_admin_field(
					...
					galatia_edge_add_admin_field(
						array(
							...
							'description'   => esc_html__( 'Specify title vertical alignment', 'galatia' ),
							'parent'        => $show_title_area_container,
							'options'       => array(
		...
		do_action( 'galatia_edge_action_additional_title_area_options_map', $show_title_area_container );
		
		/***************** Additional Title Area Layout - end *****************/
		
		
		$panel_typography = galatia_edge_add_admin_panel(
			array(
				'page'  => '_title_page',
			...
			$group_page_title_styles = galatia_edge_add_admin_group(
				array(
					'name'        => 'group_page_title_styles',
					'title'       => esc_html__( 'Title', 'galatia' ),
					'description' => esc_html__( 'Define styles for page title', 'galatia' ),
					'parent'      => $panel_typography
				)
			);
		
				$row_page_title_styles_1 = galatia_edge_add_admin_row(
					array(
				...
				$row_page_title_styles_2 = galatia_edge_add_admin_row(
					array(
				...
				$row_page_title_styles_3 = galatia_edge_add_admin_row(
					array(
			...
			galatia_edge_add_admin_section_title(
				array(
					...
					'title'  => esc_html__( 'Subtitle', 'galatia' ),
					'parent' => $panel_typography
				)
			);
		
			$group_page_subtitle_styles = galatia_edge_add_admin_group(
				array(
					'name'        => 'group_page_subtitle_styles',
					'title'       => esc_html__( 'Subtitle', 'galatia' ),
					'description' => esc_html__( 'Define styles for page subtitle', 'galatia' ),
					'parent'      => $panel_typography
				)
			);
		
				$row_page_subtitle_styles_1 = galatia_edge_add_admin_row(
					array(
				...
				$row_page_subtitle_styles_2 = galatia_edge_add_admin_row(
					array(
				...
				$row_page_subtitle_styles_3 = galatia_edge_add_admin_row(
					array(
		...
		do_action( 'galatia_edge_action_additional_title_typography_options_map', $panel_typography );
		
		/***************** Additional Title Typography Layout - end *****************/
    }

	add_action( 'galatia_edge_action_options_map', 'galatia_edge_title_options_map', galatia_edge_set_options_map_position( 'title' ) );
}