		...
		<div class="edgtf-title-inner">
			<div class="edgtf-grid">
                <div class="edgtf-title-side-padding-holder" <?php galatia_edge_inline_style($padding_styles) ?>>
                    <?php if(!empty($title)) { ?>
                        <<?php echo esc_attr($title_tag); ?> class="edgtf-page-title entry-title" <?php galatia_edge_inline_style($title_styles); ?>><?php echo esc_html($title); ?></<?php echo esc_attr($title_tag); ?>>
                    <?php } ?>
                    <?php if(!empty($subtitle)){ ?>
                        <<?php echo esc_attr($subtitle_tag); ?> class="edgtf-page-subtitle" <?php galatia_edge_inline_style($subtitle_styles); ?>><?php echo esc_html($subtitle); ?></<?php echo esc_attr($subtitle_tag); ?>>
                    <?php } ?>
                </div>
			</div>
	    </div>
